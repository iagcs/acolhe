...
{
    /**
     * Create a new UpdateSessionAction instance.
     *
     * @param ShowSessionAction $showSessionAction Action used to retrieve a session before applying updates.
     */
    ...
    /**
     * Update a session's status, schedule, type, and private notes, persist the changes, and dispatch resulting events.
     *
     * Applies any of the provided UpdateSessionData fields (status, scheduled_at, duration_minutes, type, notes,
     * cancellation_reason) to the target session, refreshes it, and dispatches SessionCancelled, SessionStatusChanged,
     * or SessionRescheduled as appropriate.
     *
     * @param User $user The acting user performing the update.
     * @param string $id The identifier of the session to update.
     * @param UpdateSessionData $data The update payload containing optional fields to apply.
     * @return Session The refreshed Session after updates have been applied.
     * @throws InvalidSessionStatusTransitionException If the requested status change is not permitted.
     */
